...
public class GeoProperties {
    ...
    // Stable Regolith
    public static final GeoProp DIRT = new GeoProp(Hardness.REGOLITH, MaterialColor.DIRT, new GeoLoot(ConstantRange.of(1), Blocks.DIRT::asItem));
    public static final GeoProp COARSE_DIRT = new GeoProp(Hardness.REGOLITH, MaterialColor.DIRT, new GeoLoot(ConstantRange.of(1), Blocks.COARSE_DIRT::asItem));
    public static final GeoProp CLAY = new GeoProp(Hardness.REGOLITH, MaterialColor.DIRT, new GeoLoot(ConstantRange.of(1), Blocks.CLAY::asItem));
    public static final GeoProp LATERITE = new GeoProp(Hardness.HARD, MaterialColor.DIRT);

    // Falling Regolith
    public static final GeoProp SAND = new GeoProp(Hardness.REGOLITH, MaterialColor.SAND, new GeoLoot(ConstantRange.of(1), Blocks.SAND::asItem));
    public static final GeoProp RED_SAND = new GeoProp(Hardness.REGOLITH, MaterialColor.SAND, new GeoLoot(ConstantRange.of(1), Blocks.RED_SAND::asItem));
    public static final GeoProp PINK_SAND = new GeoProp(Hardness.REGOLITH, MaterialColor.SAND);
    public static final GeoProp BLACK_SAND = new GeoProp(Hardness.REGOLITH, MaterialColor.SAND);
    public static final GeoProp WHITE_SAND = new GeoProp(Hardness.REGOLITH, MaterialColor.SAND);
    public static final GeoProp GRAVEL = new GeoProp(Hardness.REGOLITH, MaterialColor.DIRT, new GeoLoot(ConstantRange.of(1), Blocks.GRAVEL::asItem));
    public static final GeoProp DUNE_SAND = new GeoProp(Hardness.REGOLITH, MaterialColor.SAND);
    public static final GeoProp GYPSUM_SAND = new GeoProp(Hardness.REGOLITH, MaterialColor.SAND);
