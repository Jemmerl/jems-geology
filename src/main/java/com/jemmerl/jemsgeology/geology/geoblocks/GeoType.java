...
public enum GeoType {
    ...
    ROCKSALT("rocksalt",                        GeoGroup.SED_EVAPORITE, false, MaterialColor.STONE, new GeoLoot(RandomValueRange.of(2,5), ModItems.ROCKSALT_ORE)),
    GYPSUM("gypsum",                            GeoGroup.SED_EVAPORITE, false, MaterialColor.STONE, new GeoLoot(RandomValueRange.of(2,5), ModItems.GYPSUM_ORE)),
